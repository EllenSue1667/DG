  ...
  <body>
    ...
    <header>
      ...
      <div class="header">
        ...
        <div class="cart">
          <iframe src="https://www.wordplace.com/my-cart.php" width="190" height="80" style="border: 0px;" frameBorder="0" scrolling="no">
      ...
      <div class="altheader">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
              ...
              <li role="presentation"><a role="menuitem" tabindex="-1" href="./Workbook.php">Workbook</a></li>
              <li role="presentation"><a role="menuitem" tabindex="-1" href="./eBook.php">eBook</a></li>
          ...
          <div class="shopping">
            <a href="https://www.wordplace.com/shopping-cart.php"><i class="fas fa-shopping-cart"></i></a>
          </div>
    ...
    <div class="lesson">
      ...
      <div class="main">
        ...
        <div class="search">
          ...
          <span class="searchcode"><script>
            (function() {
              var cx = '013863017287466972435:z5wdqhj0txo';
